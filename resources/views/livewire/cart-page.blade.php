            ...
            <div class="flex flex-col gap-4 md:flex-row">
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                        ...
                                        <td class="py-4">
                                            <div class="flex items-center">
                                                <img class="w-16 h-16 mr-4" src="{{ url('storage', $item['images']) }}"
                                                    alt="{{ $item['name_en'] }}">
                                                <span class="font-semibold">{{ $item['name_en'] }}</span>
                                            </div>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5"
                                            class="py-4 font-semibold text-center text-4x1 text-slate-500">No items in
                                            the cart</td>
                                    </tr>
                                @endforelse
                ...
                <div class="md:w-1/4">
                    <div class="p-6 bg-white rounded-lg shadow-md">
                        ...
                        @if ($cart_items)
                            <a wire:navigate href="/checkout" class="block w-full px-4 py-2 mt-4 text-center text-white bg-blue-500 rounded-lg">Checkout</a>
                        @endif
                    </div>
                </div>
            </div>
