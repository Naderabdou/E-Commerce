            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 md:col-span-12 lg:col-span-4">
                    ...
                    <button type="submit"
                      ...
                      <span wire:loading.remove>Place Order</span>    <span wire:loading wire:target='placeOrder'>Processing...</span>
                    </button>
                                ...
                                <li class="py-3 sm:py-4" wire:key='{{ $item['product_id'] }}'>
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img alt="{{ $item['name_en'] }}" class="w-12 h-12 rounded-full"
                                        ...
                                        <div
                                            ...
                                            {{ Number::currency($item['unit_amount'], 'EGP') }}
                                        </div>
                                    </div>
                                </li>
                            @endforeach
