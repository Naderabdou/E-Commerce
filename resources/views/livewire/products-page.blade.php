                                    ...
                                    <li class="mb-4" wire:key='{{ $category->id }}'>
                                        <label for="{{ $category->slug }}"
                                            ...
                                            <input type="checkbox" id="{{ $category->slug }}"
                                                ...
                                                class="w-4 h-4 mr-2">
                                            <span class="text-lg">{{ $category->name_en }}</span>
                                        </label>
                                    </li>
                                @endforeach
                                    ...
                                    <li class="mb-4" wire:key='{{ $brand->id }}'>
                                        <label for="{{ $brand->slug }}" class="flex items-center dark:text-gray-300">
                                            <input type="checkbox" wire:model.live='selected_brands'
                                                ...
                                                class="w-4 h-4 mr-2">
                                            <span class="text-lg dark:text-gray-400">{{ $brand->name_en }}</span>
                                        </label>
                                    </li>
                                @endforeach
                                ...
                                <li class="mb-4">
                                    <label for="on_sale" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="on_sale" value="1" wire:model.live='on_sale'
                                            class="w-4 h-4 mr-2">
                                        <span class="text-lg dark:text-gray-400">Sale Products</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div>
                                ...
                                <input type="range"
                                    ...
                                    max="1000" step="100" value="10000" wire:model.live='price_range'>
                                <div class="flex justify-between ">
                                    <span class="inline-block text-lg font-bold text-blue-400 ">
                                        {{ Number::currency(100, 'EGP') }}</span>
                                    <span class="inline-block text-lg font-bold text-blue-400 ">
                                        {{ Number::currency(1000, 'EGP') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
