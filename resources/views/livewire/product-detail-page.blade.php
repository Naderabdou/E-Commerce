                ...
                <div class="sticky top-0 z-50 overflow-hidden ">
                  ...
                  <div class="flex-wrap hidden md:flex ">
                    ...
                    <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ url('storage',$image) }}'">
                        <img src="{{ url('storage',$image) }}" alt="" class="object-cover w-full cursor-pointer lg:h-20 hover:border hover:border-blue-500">
                      </div>
                    @endforeach
                ...
                <div class="lg:pl-20">
                  <div class="mb-8 [&>ul]:list-disc  [&>ul]:ml-4">
                    ...
                    <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                      ...
                      {{-- <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ $product->price }}</span> --}}
                    </p>
                    <p class="max-w-md text-gray-700 dark:text-gray-400">
                        {!! Str::markdown($product->description_en) !!}
                    </p>
                  </div>
                  <div class="w-32 mb-8 ">
                    ...
                    <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                      ...
                      <input type="number" wire:model='qty' readonly class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="1">
